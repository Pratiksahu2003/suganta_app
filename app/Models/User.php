...
class User extends Authenticatable implements MustVerifyEmail, CanResetPassword
{
    ...
    /**
     * Get conversations initiated by this user
     */
    ...
    {
        return Conversation::where('initiator_id', $this->id)
     ...
     * Block a user
     */
    public function blockUser($userId, $reason = null): bool
    {
        if (!$this->hasBlocked($userId)) {
            BlockedUser::blockUser($this->id, $userId, $reason);
            return true;
        }
        return false;
    }
    ...
    {
        return BlockedUser::unblockUser($this->id, $userId);
    }
