...
{
    /**
     * Map teacher profile + optional teachingInfo to option structures.
     ...
     */
    public static function mapTeacherOptions(object $teacher, ?object $teachingInfo): array
    {
        ...
        return [
            ...
            'hourly_rate_range' => $opt('hourly_rate_range', $teachingInfo?->hourly_rate_id ?? null),
            'monthly_rate_range' => $opt('monthly_rate_range', $teachingInfo?->monthly_rate_id ?? null),
            'experience_years' => $opt('teaching_experience_years', $teacher->experience_years),
        ];
    }
